...
<a id="pydata-eindhoven" class="ev-chip" style="--ev-color:#00bfa5" href="https://www.meetup.com/pydata-eindhoven/" target="_blank" rel="noreferrer noopener"><img src="assets/logos/pydata.png" alt="PyData Eindhoven"><span class="ev-chip-text"><span class="ev-chip-name">PyData Eindhoven</span><span class="ev-chip-role">Organizing Committee Chair &amp; Community Manager</span><span class="ev-chip-meta">1,210 members · 4.7★ · Largest paid AI event in Eindhoven (~350 attendees) · €75k+ raised for OSS</span></span></a>
