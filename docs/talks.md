...
**LinkedIn Live Webinar** · Aug 29, 2024

A webinar on testing practices with MATLAB, hosted live on LinkedIn.

[View slides (PDF)](assets/testing-with-matlab.pdf) ·
[View event on LinkedIn](https://www.linkedin.com/event/manage/7228740232450314240/){ target=_blank rel="noreferrer noopener" }

### ![Julia](assets/logos/julia.svg){ width="36" } MATLAB → Julia
...
[View abstract](https://040coders.nl/abstracts/2025-03-Gareth-Thomas.shtml){ target=_blank rel="noreferrer noopener" }

### ![Playwright](assets/logos/playwright.svg){ width="120" } Top 10 Lessons Learnt in Adopting Playwright

**Playwright Evening @ ProRail** · May 19, 2026 · Utrecht, Netherlands :flag_nl:
...
### ![MATLAB](assets/logos/mathworks.png){ width="36" } First Steps in Reinforcement Learning Using MATLAB

**Data Science Utrecht** · Dec 10, 2019 · Utrecht, Netherlands :flag_nl:
...
[View slides (PDF)](assets/first-steps-reinforcement-learning-matlab.pdf) ·
[View event on Meetup](https://www.meetup.com/data-science-utrecht/events/266562697/){ target=_blank rel="noreferrer noopener" }
...
### ![MATLAB](assets/logos/mathworks.png){ width="36" } Leveraging GitHub as a MATLAB User

**Technical Computing Camp 2024** · Hotel Rakovec, Brno Dam, Czech Republic
...
[View slides (PDF)](assets/Leveraging%20GitHub%20for%20MATLAB%20Users.pdf) ·
[View event on humusoft.com](https://www.humusoft.com/archive/tcc2024/){ target=_blank rel="noreferrer noopener" }
...
[Listen on arraycast.com](https://www.arraycast.com/2024/05/11/MATLAB.html){ target=_blank rel="noreferrer noopener" }
...
[Listen on Spotify](https://creators.spotify.com/pod/profile/jousef-murad/episodes/MATLAB-vs--Python-vs--Julia-The-Hidden-Truths---Gareth-Thomas--Podcast-147-e2vdsag){ target=_blank rel="noreferrer noopener" }
